    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Car_dealer.area')),
                ('dealer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Car_dealer.dealer')),
            ],
        ),
    ]
